...
fn instantiation() {
    ...
    assert_eq!("020200", encode(xmss.base.get_descriptor().get_bytes()));
    assert_eq!(
        "0202000000000000000000000000000000000000000000000000".to_owned()
    ...
    assert_eq!(
        "0202000f9ec8efa448051a110686084a47b3ff2c497067edd68b91f36f18c1d7a78498e49b0750",
